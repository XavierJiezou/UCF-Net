...
from third_party.dinov3.configs import setup_config, setup_job, setup_multidistillation
from third_party.dinov3.data import (
    MaskingGenerator,
    SamplerType,
...
from third_party.dinov3.train.cosine_lr_scheduler import CosineScheduler, linear_warmup_cosine_decay
from third_party.dinov3.train.multidist_meta_arch import MultiDistillationMetaArch
from third_party.dinov3.train.ssl_meta_arch import SSLMetaArch
