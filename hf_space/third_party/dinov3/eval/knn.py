...
import third_party.dinov3.distributed as distributed
from third_party.dinov3.data import SamplerType, make_data_loader, make_dataset
from third_party.dinov3.data.adapters import DatasetWithEnumeratedTargets
from third_party.dinov3.data.transforms import (
    CROP_DEFAULT_SIZE,
    RESIZE_DEFAULT_SIZE,
    get_target_transform,
    make_classification_eval_transform,
)
from third_party.dinov3.distributed import gather_all_tensors
from third_party.dinov3.eval.data import (
    create_train_dataset_dict,
    extract_features_for_dataset_dict,
    get_num_classes,
    pad_multilabel_and_collate,
)
from third_party.dinov3.eval.helpers import args_dict_to_dataclass, cli_parser, write_results
from third_party.dinov3.eval.metrics import ClassificationMetricType, build_classification_metric
from third_party.dinov3.eval.setup import ModelConfig, load_model_and_context
from third_party.dinov3.eval.utils import ModelWithNormalize, average_metrics, evaluate
from third_party.dinov3.eval.utils import save_results as default_save_results_func
from third_party.dinov3.run.init import job_context
